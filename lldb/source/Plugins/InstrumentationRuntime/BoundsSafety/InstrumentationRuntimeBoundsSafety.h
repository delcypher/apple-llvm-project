...
private:
  ...
  // FIXME: This is kind of a hack to handle the fact we can match up to two
  // breakpoints. The corresponding fields from the parent class hold
  // the call_with_code_breakpoint.
  lldb::ModuleSP m_runtime_module_id_call_with_str;
  lldb::user_id_t m_breakpoint_id_call_with_str = LLDB_INVALID_BREAK_ID;
};
