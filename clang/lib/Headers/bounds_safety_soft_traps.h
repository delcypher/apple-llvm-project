...
/// `-fbounds-safety-soft-traps=call_with_str`. This function is allowed to
/// to return.
///
...
// TODO(dliew): Document the `reason_code` values.

/// Called when a `-fbounds-safety` bounds check fails when building with
/// `-fbounds-safety-soft-traps=call_with_code`. This function is allowed to
/// to return.
///
