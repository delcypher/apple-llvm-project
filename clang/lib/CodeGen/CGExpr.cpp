...
void CodeGenFunction::EmitTrapCheck(llvm::Value *Checked,
  ...
  NoMerge |= CGM.getCodeGenOpts().TrapFuncReturns ||
             CGM.getCodeGenOpts().getBoundsSafetySoftTraps() !=
                 CodeGenOptions::BoundsSafetySoftTrapKind::Disabled;
  /*TO_UPSTREAM(BoundsSafety) OFF*/
  ...
  if (TrapBB && !NoMerge) {
    ...
    if (CGM.getCodeGenOpts().getBoundsSafetySoftTraps() !=
            CodeGenOptions::BoundsSafetySoftTrapKind::Disabled &&
        CheckHandlerID == SanitizerHandler::BoundsSafety) {
      ...
      switch (CGM.getCodeGenOpts().getBoundsSafetySoftTraps()) {
      ...
      default:
        llvm_unreachable("Unhandled BoundsSafetySoftTrapKind");
      }
