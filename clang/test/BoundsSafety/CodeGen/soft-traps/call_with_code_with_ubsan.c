...
// RUN: %clang_cc1 -O3 -fbounds-safety -triple arm64-apple-iphoneos \
// RUN:   -emit-llvm %s -o - -fbounds-safety-soft-traps=call_with_code \
// RUN:   -fsanitize=signed-integer-overflow \
// RUN:   -fsanitize-trap=signed-integer-overflow | \
...
//.
// UNOPT: @.src = private unnamed_addr constant [136 x i8] c"/Volumes/user_data/dev/llvm/upstream_swift/next/src/llvm-project/clang/test/BoundsSafety/CodeGen/soft-traps/call_with_code_with_ubsan.c\00", align 1
// UNOPT: @[[GLOB0:[0-9]+]] = private unnamed_addr constant { i16, i16, [6 x i8] } { i16 0, i16 11, [6 x i8] c"'int'\00" }
//.
// UNOPT-TF: @.src = private unnamed_addr constant [136 x i8] c"/Volumes/user_data/dev/llvm/upstream_swift/next/src/llvm-project/clang/test/BoundsSafety/CodeGen/soft-traps/call_with_code_with_ubsan.c\00", align 1
// UNOPT-TF: @[[GLOB0:[0-9]+]] = private unnamed_addr constant { i16, i16, [6 x i8] } { i16 0, i16 11, [6 x i8] c"'int'\00" }
//.
// UNOPT-TFR: @.src = private unnamed_addr constant [136 x i8] c"/Volumes/user_data/dev/llvm/upstream_swift/next/src/llvm-project/clang/test/BoundsSafety/CodeGen/soft-traps/call_with_code_with_ubsan.c\00", align 1
...
// OPT-NEXT:    [[AGG_TEMP_SROA_3_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP_SROA_3_0_PTR_SROA_IDX]], align 8, !tbaa [[INTPTR_TBAA4:![0-9]+]]
...
// OPT:       [[CONT6]]:
// OPT-NEXT:    [[TMP4:%.*]] = load i32, ptr [[ARRAYIDX]], align 4, !tbaa [[INT_TBAA11:![0-9]+]]
...
// OPT: [[INTPTR_TBAA4]] = !{[[META5:![0-9]+]], [[META5]], i64 0}
...
// OPT: [[INT_TBAA11]] = !{[[META12:![0-9]+]], [[META12]], i64 0}
