...
// CHECK-NEXT: {{^}}|     | | |-OpaqueValueExpr [[ove:0x[^ ]+]] {{.*}} 'void *__single __sized_by()':'void *__single'
...
// CHECK-NEXT: {{^}}|     | | |   |   `-OpaqueValueExpr [[ove]] {{.*}} 'void *__single __sized_by()':'void *__single'
...
// CHECK-NEXT: {{^}}|     |   `-CallExpr
// CHECK-NEXT: {{^}}|     |     |-ImplicitCastExpr {{.+}} 'void *__single __sized_by()(*)(void *__single __sized_by(), const void *__single __sized_by(), unsigned long)' <BuiltinFnToFnPtr>
// CHECK-NEXT: {{^}}|     |     | `-DeclRefExpr {{.+}}
// CHECK-NEXT: {{^}}|     |     |-ImplicitCastExpr {{.+}} 'void *__single __sized_by()':'void *__single' <BoundsSafetyPointerCast>
...
// CHECK-NEXT: {{^}}|         |-MaterializeSequenceExpr {{.+}} <Bind>
// CHECK-NEXT: {{^}}|         | |-BoundsSafetyPointerPromotionExpr {{.+}} 'void *__bidi_indexable'
// CHECK-NEXT: {{^}}|         | | |-OpaqueValueExpr [[ove_4:0x[^ ]+]] {{.*}} 'void *__single __sized_by()':'void *__single'
...
// CHECK-NEXT: {{^}}|         | | |   |-CStyleCastExpr {{.+}} 'char *' <BitCast>
// CHECK-NEXT: {{^}}|         | | |   | `-ImplicitCastExpr {{.+}} 'void *' <BoundsSafetyPointerCast>
// CHECK-NEXT: {{^}}|         | | |   |   `-OpaqueValueExpr [[ove_4]] {{.*}} 'void *__single __sized_by()':'void *__single'
// CHECK:      {{^}}|         | | |   `-AssumptionExpr
...
// CHECK-NEXT: {{^}}|   |       |-MaterializeSequenceExpr {{.+}} <Bind>
// CHECK-NEXT: {{^}}|   |       | |-BoundsSafetyPointerPromotionExpr {{.+}} 'void *__bidi_indexable'
// CHECK-NEXT: {{^}}|   |       | | |-OpaqueValueExpr [[ove_8:0x[^ ]+]] {{.*}} 'void *__single __sized_by()':'void *__single'
...
// CHECK-NEXT: {{^}}|   |       | | |   |-CStyleCastExpr {{.+}} 'char *' <BitCast>
// CHECK-NEXT: {{^}}|   |       | | |   | `-ImplicitCastExpr {{.+}} 'void *' <BoundsSafetyPointerCast>
// CHECK-NEXT: {{^}}|   |       | | |   |   `-OpaqueValueExpr [[ove_8]] {{.*}} 'void *__single __sized_by()':'void *__single'
// CHECK:      {{^}}|   |       | | |   `-AssumptionExpr
